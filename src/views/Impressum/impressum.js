        ...
        <div className="main">
          <div class="body">
            ...
            <p>
              ...
              <br></br> Fax: 09732 / 1869 <br></br>E-Mail: drdettner@gmail.com
            </p>
          </div>
          <br></br>
          <div class="body">
            <p style={{ color: "#5ecd73" }}>
          ...
          <br></br>
          <div class="body">
            <p style={{ color: "#5ecd73" }}>Ärztekammer:</p>
            <p>
              Bayerische Landesärztekammer <br></br> Mühlbaurstraße 16 <br></br>
          ...
          <br></br>
          <div class="body">
            <p style={{ color: "#5ecd73" }}>Bildrechte:</p>
            <p>
          ...
          <div class="body">
            <p style={{ color: "#5ecd73" }}>Streitschlichtung:</p>
            <p>
              ...
              E-Mail-Adresse finden Sie oben im Impressum. Gleichzeitig erfolgt
              hier der Hinweis, dass wir nicht bereit sind, uns am
          ...
          <div class="body">
            ...
            <p>
              ...
              Korrektheit und der gegenwärtigen Gültigkeit dieser Inhalte. Beim
              Aufruf dieser Inhalte kommt es zu keinem Vertragsverhältnis
          ...
          <div class="body">
            ...
            <p>
              ...
              in Erfahrung gebracht, so werden diese Verknüpfungen zu Webseiten
              Dritter unmittelbar entfernt.
            </p>
          </div>
          ...
          <div class="body">
            ...
            <p>
              ...
              entfernen.<br></br>Auch die Darbietung dieser Webseite in fremden
              Frames bedarf der vorherigen Zustimmung vom Seitenbetreiber.
            </p>
          </div>
        </div>
      </div>
